...
-- BACKDROP_SLIDER_8_8 (nil on 3.3.5a); set it with the native SetBackdrop instead
-- so the Frame Height / Frame Width sliders show a draggable bar.
function CompactUnitFrameProfilesSlider_SetTrack(self)
	self:SetBackdrop({
